...
const hardWords = getHardWords()
  ...
  return (
    <div style={{
      ...
      {/* İçerik */}
      <div style={{
        maxWidth: '720px', margin: '-16px auto 0',
        padding: '0 24px 40px',
      }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <span>İlerleme</span><span>4 / 10</span>
          </div>
          <div style={{
            height: '8px', background: '#F1F5F9',
            borderRadius: '4px', overflow: 'hidden', marginBottom: '16px',
          }}>
            <div style={{ height: '100%', width: '40%', background: '#F59E0B', borderRadius: '4px' }} />
          </div>
          <button
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '14px' }}>
              ...
              <div>
                ...
                <div style={{ fontSize: '13px', color: '#64748B' }}>
                  Tekrar pratik yapmanı öneririz
                </div>
              </div>
            </div>
